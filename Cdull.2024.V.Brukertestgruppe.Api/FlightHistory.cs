...
namespace Cdull._2024.V.Brukertestgruppe.Api
{
    internal class FlightHistory
    {
        ...
        private List<FlightHistory> allFlightHistories;
        public FlightHistory(string FlightNumber, List<string> UsedGates, List<string> UsedRunways, DateTime TimeStamps);
